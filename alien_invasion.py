...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Создание экзмепляра для хранения игровой статистики.
    ...
    def _fire_bullet(self):
        """Создаие нового снаряда и включение его в группу bullets."""
    ...
    def _ship_hit(self):
        ...
        # Уменьшение ships_left и одновление панели счета
    ...
    def _update_aliens(self):
        ...
        обновлением всех пришельцев во флоте"""
        ...
        # проверить добралиси ли пришельцы до нижнего края экрана
